...
class RawPosting(BaseModel):
    ...
    organisation: str | None = Field(
        description="The name of the organisation which posted the job"
    )
    remote: bool | None = Field(
        default=None, description="True if the source marks the role remote."
    )
    description: str | None = None
    url: str | None = None
    posted_at: date | None = None
    tags: list[str] = Field(
        default_factory=list, description="Source-provided skill/category tags."
    )
